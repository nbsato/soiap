...
! unit cell
  call getkeyvalue("input.dat","unit_vec",unit=ifin,status=ret)
  write(*,*)'unit_vec'
  do i=1,3
  ...
  call getkeyvalue("input.dat","unit_vec_column",icolumn,default=1)
  if (icolumn==2) then
     uv=transpose(uvin)
  ...
  call getkeyvalue("input.dat","unit_length",ilength,default=1)
...
! informtion of atoms
  call getkeyvalue("input.dat","number_atom",natom,default=0)
  ...
  call getkeyvalue("input.dat","number_element",nkatm,default=0)
  write(*,*)'number of elements =',nkatm
  allocate(zatm(natom),katm(natom),mass(natom),mfac(natom))
  mconv=(1.6605655d-27/9.109534d-31)*0.5d0

  call getkeyvalue("input.dat","atom_pos",iatompos,default=1)

  call getkeyvalue("input.dat","atom_list",unit=ifin,status=ret)
  do i=1,natom
...
! optimization
  call getkeyvalue("input.dat","number_max_relax",nloopa,default=10)
  write(*,*)'number_max_relax =',nloopa

  call getkeyvalue("input.dat","md_mode",imd,default=0)
  write(*,*)'md_mode =',imd

  call getkeyvalue("input.dat","number_max_relax_cell",nloopc,default=0)
  write(*,*)'number_max_relax_cell =',nloopc

  call getkeyvalue("input.dat","external_stress_v",extstrs,3,default=(/0.0d0,0.0d0,0.0d0/))
  write(*,"(a17,3f12.6)")'external_stress_v =',extstrs

  call getkeyvalue("input.dat","time_step",tstep,default=300.d0)
  write(*,*)'time_step =',tstep

  call getkeyvalue("input.dat","th_force",fth,default=5.d-5)
  write(*,*)'th_force =',fth

  call getkeyvalue("input.dat","th_stress",sth,default=5.d-7)
  write(*,*)'th_stress =',sth

! lattice_mass in QMAS
  call getkeyvalue("input.dat","mass_cell",mcell,default=5.d-4)
  write(*,*)'mass_cell =',mcell ! mltc in QMAS

! cell_opt_mode in QMAS
  call getkeyvalue("input.dat","md_mode_cell",imdc,default=2)
...
! force field
  call getkeyvalue("input.dat","force_field",ifrcf,default=0)
